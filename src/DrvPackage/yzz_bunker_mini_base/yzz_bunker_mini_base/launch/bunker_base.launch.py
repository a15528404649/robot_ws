...
def generate_launch_description():
    ...
    publish_tf_arg = DeclareLaunchArgument('publish_tf', default_value='true',
                                           description='Whether yzz_bunker_mini_base publishes odom -> base_link TF')
    ...
    yzz_bunker_mini_base_node = launch_ros.actions.Node(
        package='yzz_bunker_mini_base',
        executable='yzz_bunker_mini_base_node',
        output='screen',
        emulate_tty=True,
        parameters=[{
