...
# 移除 ultralytics 依赖（兼容 Python 3.6）
# try:
#     import ultralytics
...
# 简化版 colors 和 save_one_box
def colors(id, bgr=False):
    """返回颜色列表中的颜色"""
    palette = [
        (255, 56, 56), (255, 157, 151), (255, 112, 31), (255, 178, 29), (207, 210, 49),
        (72, 249, 10), (146, 204, 23), (61, 219, 134), (26, 147, 52), (0, 212, 187),
        (44, 153, 168), (0, 194, 255), (52, 69, 253), (100, 0, 248), (174, 0, 253),
        (253, 0, 252), (255, 0, 125), (255, 0, 0), (255, 63, 0), (255, 116, 0),
    ]
    c = palette[int(id) % len(palette)]
...
def save_one_box(xyxy, im, file='image.jpg', gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    h, w = im.shape[:2]
    b = [xyxy[0] - pad, xyxy[1] - pad, xyxy[2] + pad, xyxy[3] + pad]
    b[0] = max(0, b[0])
    b[1] = max(0, b[1])
    b[2] = min(w, b[2])
    b[3] = min(h, b[3])
...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if label:
            ...
            cv2.putText(self.im, label, (p1[0], p1[1] - 2), 0, self.lw / 3, txt_color, thickness=tf, lineType=cv2.LINE_AA)
